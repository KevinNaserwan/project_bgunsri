            ...
            <div class="container img" data-aos="fade-up">
                ...
                <div class="row my-auto">
                    <div class="col-lg-6 content order-last  order-lg-last mx-auto">
                        ...
                        <h2>Motivasi</h2>
                        {{-- <button id="tambah-sekolah" class="btn btn-primary btn-block my-4">Tambah Kemampuan</button> --}}
                        <form action="/postregist7/{{Session('nim')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="motivasi">Motivasi</label>
                                                <textarea type="text" name="motivasi" id="motivasi"
                                                    class="form-control" placeholder="Masukkan Motivasi Anda ...."
                                                    cols="30" rows="15" required ></textarea>
                                                <p class=" py-2 text-warning">* Motivasi Anda mengikuti Pemilihan Bujang Gadis Unsri</p>
                                            </div>
                                        </div>
                                    </div>
                            </div>
    ...
    <script>
        ...
        function tambahSekolah() {
            ...
            <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="bidang">Bidang</label>
                                                <input type="text" name="bidang[]" id="bidang"
                                                    class="form-control" placeholder="Masukkan Bidang Anda ...."
                                                    required />
                                                <p class=" py-2 text-warning">* Contoh : Creative</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="keahlian">Keahlian</label>
                                                <input type="text" name="keahlian[]" id="keahlian"
                                                    class="form-control" placeholder="Masukkan Keahlian Anda ...." />
                                                <p class=" py-2 text-warning">* Contoh : Editing, Fotografi</p>
                                            </div>
                                        </div>
                                    </div>
            `;

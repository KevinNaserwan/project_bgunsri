            ...
            <div class="container img" data-aos="fade-up">
                ...
                <div class="row my-auto">
                    <div class="col-lg-6 content order-last  order-lg-last mx-auto">
                        ...
                        <form action="/postregist2/{{Session('nim')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="nama_sekolah">Nama
                                                    Sekolah</label>
                                                <input type="text" name="nama_sekolah[]" id="nama_sekolah"
                                                    class="form-control" placeholder="Masukkan Nama Sekolah Anda ...."
                                                    required />
                                                <p class=" py-2 text-warning">* Contoh : SMA negeri 01 Palembang</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">

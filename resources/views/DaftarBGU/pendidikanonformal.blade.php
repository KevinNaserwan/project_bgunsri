            ...
            <div class="container img" data-aos="fade-up">
                ...
                <div class="row my-auto">
                    <div class="col-lg-6 content order-last  order-lg-last mx-auto">
                        ...
                        <button id="tambah-sekolah" class="btn btn-primary btn-block my-4">Tambah Sekolah</button>
                        <form action="/postregist3/{{Session('nim')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div id="sekolah-container">
                                <div class="sekolah">
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="jenis_pendidikan">Jenis Pendidikan</label>
                                                <input type="text" name="jenis_pendidikan[]" id="jenis_pendidikan"
                                                    class="form-control" placeholder="Masukkan Jenis Pendidikan Anda ...."
                                                    required />
                                                <p class=" py-2 text-warning">* Contoh : Kursus Komputer</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="nama_lembaga">Nama
                                                    Lembaga</label>
                                                <input type="text" name="nama_lembaga[]" id="nama_lembaga"
                                                    class="form-control" placeholder="Masukkan Nama Lembaga ...."
                                                    required />
                                                <p class=" py-2 text-warning">* Contoh : Palcomtech</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="tahun_masuk">Tahun
                                                    Masuk</label>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="tahun_keluar">Tahun
                                                    keluar</label>
                                                <input type="number" name="tahun_keluar[]" id="tahun_keluar"
                                                    class="form-control" placeholder="Masukkan Tahun keluar ...." />
                                                <p class=" py-2 text-warning">* Contoh : 2003</p>
                                            </div>
                                        </div>
                                    </div>

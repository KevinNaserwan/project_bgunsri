            ...
            <div class="container img" data-aos="fade-up">
                ...
                <div class="row my-auto">
                    <div class="col-lg-6 content order-last  order-lg-last mx-auto">
                        ...
                        <h2>Prestasi</h2>
                        <button id="tambah-sekolah" class="btn btn-primary btn-block my-4">Tambah Prestasi</button>
                        <form action="/postregist6/{{Session('nim')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="nama_penghargaan">Nama Penghargaan</label>
                                                <input type="text" name="nama_penghargaan[]" id="nama_penghargaan"
                                                    class="form-control" placeholder="Masukkan Nama Penghargaan Anda ...."
                                                    required />
                                                <p class=" py-2 text-warning">* Contoh : Juara 1 UI/UX Gemastik</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="instansi">Instansi</label>
                                                <input type="text" name="instansi[]" id="instansi"
                                                    class="form-control" placeholder="Masukkan Instansi ...."
                                                    required />
                                                <p class=" py-2 text-warning">* Contoh : Universitas Sriwijaya</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="tahun">Tahun</label>
                                                <input type="number" name="tahun[]" id="tahun"
                                                    class="form-control" placeholder="Masukkan Tahun ...." />
                                                <p class=" py-2 text-warning">* Contoh : 2003</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col">
                                            <div class="form-outline">
                                                <label class="form-label text-warning" for="sertifikat">Sertifikat</label>
                                                <input type="file" name="sertifikat" id="sertifikat"
                                                    class="form-control" placeholder="Masukkan Sertifikat Anda ...." />
                                                <p class=" py-2 text-warning">* Jadikan Dalam Satu PDF Lalu Upload</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
